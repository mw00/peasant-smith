...
We as members, contributors, and leaders pledge to make participation in the Peasant Smith community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socioeconomic status, nationality, personal appearance, race, religion, or sexual identity and orientation.

We pledge to act and interact in ways that contribute to an open, welcoming, diverse, inclusive, and healthy community — one where hardware elitism does not define who gets to run AI.
...
- Mocking someone's hardware or setup ("just buy a 4090")
- Dismissing benchmarks from consumer/used hardware as "not real"
